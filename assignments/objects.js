...
// Log the child's age
  console.log(parent["first child"].age);

// Log the name and age of the grandchild
  console.log(parent["first child"]["first grandchild"].name, parent["first child"]["first grandchild"].age);

// Have the parent speak
console.log(parent.speak());

// Have the child speak
console.log(parent["first child"].speak());

// Have the grandchild speak\
console.log(parent["first child"]["first grandchild"].speak());
