...
console.log(`The grandchild's name is ${parent.child.child.name} and the age is ${parent.child.child.age}`)


// Have the parent speak
// Have the child speak
// Have the grandchild speak
let currentPerson = parent;
while(currentPerson !== undefined) {
  currentPerson.speak();
