...
const interns = [
  ...
  {id: 2, email: "kdiben1@tinypic.com", firstName: "Kennan", gender: "M", speak() {return `Hello my name is ${this.firstName}`} },
  {id: 3, email: "kmummery2@wikimedia.org", firstName: "Keven", gender: "M" },
  {id: 4, email: "gmartinson3@illinois.edu", firstName: "Gannie", gender: "M" },
  {id: 4, email: "adaine5@samsung.com", firstName: "Antonietta", gender: "F", multiplyNums(num1, num2) {return num1*num2} },
];
...
let antonietta = interns[interns.length - 1];
