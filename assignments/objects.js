...
antonietta.multiplyNums = (...nums) => nums.reduce((acc, curr) => acc + curr, 0);
...
const child = new Parent('George', 50, grandchild);
const parent = new Parent('Susan', 70, child);
...
const { name, age } = parent.child.child;
