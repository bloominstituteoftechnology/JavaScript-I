...
const parent = {'name': 'Susan', 'age': 78, speak: function() {return this.name} {'name': 'George', 'age': 50, speak: function() {return this.name} {'name': 'Sam', 'age': 30, speak: function() {return this.name} } } }
const parent = {
  name: 'Susan',
  age: 78,
