...
const mitzi = {
  'id': '1','email':'mmelloy0@psu.edu','name': 'Mitzi','gender': 'M',
};
const kennan = {
  'id': '2','email':'kdiben1@tinypic.com','name': 'Kennan','gender': 'M',
  'speak': function() {
    console.log("Hello My Name is Kenan!")
  }
};
const keven = {
...
antonietta.multiplyNums = function(num1, num2) { console.log(num1 * num2); return num1 * num2; }
