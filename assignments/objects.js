...
const Mitzi = new Intern(1, "Mitzi", "mmelloy@psu.edu", "F");
...
parent.speak = function() { return this.name; };
parent.child.speak = function() { return this.name; };
parent.child.grandchild.speak = function() { return this.name; };
