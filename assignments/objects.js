...
// Antonietta's Gender
console.log(interns.Antionetta.gender);
// ==== Challenge 3: Object Methods ==== 
// Give Kennan the ability to say "Hello, my name is Kennan!" Use the console.log provided as a hint.
// console.log(kennan.speak());
interns.Kennan.speak = "Hello, my name is Kennan!";
console.log(interns.Kennan.speak);
// Antonietta loves math, give her the ability to multiply two numbers together and return the product. Use the console.log provided as a hint.
//console.log(antonietta.multiplyNums(3,4));
interns.Antionetta.multiplyNums = function(a, b) { return a * b };
console.log(interns.Antionetta.multiplyNums(3, 4));
