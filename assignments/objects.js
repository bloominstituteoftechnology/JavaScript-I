...
console.log("Kenna say's:", kennan.speak());

// Antonietta loves math, give her the ability to multiply two numbers together and return the product. Use the console.log provided as a hint.
console.log(
  "Antonietta multiples 3 and 4 to get:",
...
console.log("The parent says their name:", parent.sayName());

// Have the child speak
console.log("The child says their name:", parent.child.sayName());

// Have the grandchild speak
console.log(
  "The grandchild says their name:",
