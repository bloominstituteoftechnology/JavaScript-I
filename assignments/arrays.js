...
// console.log(`Car 33 is a *car year goes here* *car make goes here* *car model goes here*` );
 ...
 function findCarInfo(array, key, value) {
 ...
 let carInfo = findCarInfo(inventory, "id", 33);
console.log(carInfo);
...
for(let i=0; i<inventory.length; i++) {
 getCarModels.push(inventory[i]["car_model"]);
}
console.log(getCarModels.sort());
...
//not my code; Solution...need to study
let oldCars =[]; 
...
console.log(oldCars.length); //this tells you HOW MANY are in this new array oldcars
...
console.log("List of all the BMW and Audi cars: " + JSON.stringify(BMWAndAudi));
