...
let lastCar = inventory[inventory.length - 1]; //Last element in an array is the length of the array minus one.
console.log(`Last Car's Make: ${lastCar.car_make} \nLast Car's Model: ${lastCar.car_model}`);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
let carModels = inventory;

carModels.sort((car1, car2) => {
...
// }
carYears = inventory.map((car) => {return car.car_year});
...
//     }
// }
oldCars = carYears.filter((year) => {return year < 2000});
console.log(`${oldCars.length} cars made before year 2000`);
