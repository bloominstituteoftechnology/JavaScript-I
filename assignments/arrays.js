...
// console.log(`${lastCar.car_model} is great`); This is a string template

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
let carModels = [];
for (let i = 0; i < inventory.length; i++) {
  // console.log(inventory[i].car_model); Run this as initial test output
  carModels.push(inventory[i].car_model);
}

//carModels.sort(); This call isnt needed because it is assigned in the carModelsSorted variable
