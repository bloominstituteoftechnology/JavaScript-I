...
let carModels = inventory.map(function(obj){
...
let carYears = inventory.map(function(obj){
  return obj.car_year;
});;
...
let oldCars = carYears.filter(oldFinder);

function oldFinder(value, index, array){
  return value < 2000;
}
