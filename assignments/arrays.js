...
for (let i = 0; i <inventory.length; i++) {
  ...
  if (currentInventory.id === 33) {
    console.log(`Car 33 is a ${currentInventory.car_year} ${currentInventory.car_make} ${currentInventory.car_model}`)
  }
}
