...
// const evens = [];
// for (let i = 0; i < arr.length; i++) {
//     //Push is use to add to an array
...
// the code below gets all the model of the cars in the array
...
//the code below sort the models of the cars in alphabetical order
let carModelsSorted = [carModels.sort()];

console.log(`sorted cars model is ` + carModelsSorted);
