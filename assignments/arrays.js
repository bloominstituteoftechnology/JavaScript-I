...
console.log("Car 33 is a " + car.car_model + " " + car.car_year + " " + car.car_make + " " + car.car_model);

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.

let lastCar = inventory.slice(-1)[0];
console.log("The last car in the lot is a:  " +lastCar.car_make + " " + lastCar.car_model + "  one of a kind son");

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
let carModels = inventory.sort((a, b) => (a.car_model > b.car_model) ? 1 : -1);
console.log(carModels); // this code is a lot easier to keep track of once we get a used to arrow functions
