...
let carModels = [];
let carModelsSorted = [];
console.log(inventory.map(function(ele) {
...
oldCars = inventory.filter(function(ele) {
	if(ele.car_year < 2000)
		return ele;
});
...
// { id: 50, car_make: "Lincoln", car_model: "Town Car", car_year: 1999 }
let BMWAndAudi = [];
BMWAndAudi = inventory.filter(function(ele) {
	if(ele.car_make === "Lincoln" || ele.car_make === "Audi")
		return ele;
});
