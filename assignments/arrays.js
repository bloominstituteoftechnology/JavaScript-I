...
console.log(`The make is: ${lastCar.car_make} and the model is: ${lastCar.car_model}`);
...
console.log(`There are ${oldCars.length} cars that are older than the year 2000.`);
...
console.log(`these are the available cars- ${myJSON}`);
