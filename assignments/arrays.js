...
console.log(`Car 33 is a inventory ${inventory[32].id} ${inventory[32].car_make} ${inventory[32].car_model}`);
//(`Car 33 is a inventory*car year goes here* *car make goes here* *car model goes here*` );
...
for(let i = 0; i < carYears.length; i++){
    ...
    //if car is older than 2000 push to old cars
    // log oldCars.length
}
