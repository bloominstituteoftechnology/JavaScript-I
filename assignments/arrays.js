...
let lastCar = `${inventory[inventory.length - 1]} ${inventory[inventory.length - 1 ]['car_make']} ${inventory[inventory.length - 1]['car_model']}   `;
console.log(lastCar);
...
for (i = 0; i < inventory.length; i++) {
    inventoryAlph.push(inventory[i].car_model)

}
console.log(inventoryAlph.sort());
