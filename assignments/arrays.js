...
var recallString = "Car 33 is a " + inventory[32].car_year + " " + inventory[32].car_make + " " +inventory[32].car_model + ".";
console.log(recallString);
// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = inventory.length;
recallString = inventory [lastCar-1].car_make + " " + inventory[lastCar-1].car_model + ".";
console.log(recallString);
...
let BMWAndAudi = inventory.filter (function(car){
    return (car.make_make == "BMW" || car.car_make == "Audi");
})
