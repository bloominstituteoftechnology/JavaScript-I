...
for(car in inventory){
  if(inventory[car]["id"] === 33){
    console.log(`Car ${inventory[car]["id"]} is a ${inventory[car]['car_year']} ${inventory[car]['car_make']} ${inventory[car]['car_model']}`)
  }
}
...
for(car in inventory){
  if(inventory[car]["id"] === lastCar){
    console.log(`The last car is a ${inventory[car]['car_make']} ${inventory[car]['car_model']}`)
  }
}
...
let carModels = [];
for (car in inventory){
  // console.log(inventory[car]["car_model"])
  let model = inventory[car]["car_model"].toLowerCase(); 
...
for(car in inventory){
  if (inventory[car]['car_year'] < 2000){
    oldCars.push(inventory[car]['car_year'])
  };
}
