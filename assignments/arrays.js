...
const cool = inventory.find(el => el.id === 33).car_year;
// ==== Challenge 1 ====
// The dealer can't recall the information for a car with an id of 33 on his lot. Help the dealer find out which car has an id of 33 by logging the car's year, make, and model in the console log provided to you below:
    console.log(`Car 33 is a ${cool} ${inventory[32].car_make} ${inventory[32].car_model}` );
...
let lastCar = 0;
console.log('the make is ' +inventory[49].car_make + ', and the model is ' + inventory[49].car_model);
