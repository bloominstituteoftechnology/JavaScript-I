...
function carQuery(num) {
    for (let i = 0; i < inventory.length; i ++) {
        if (i === num - 1 ) {
            console.log( "Car" + " " + num + " " + "is a" + " " + inventory[i].car_year + " " + inventory[i].car_make+ " " + inventory[i].car_model+ ".");
...
function lastCar() {
    for (let i = 0; i < inventory.length; i ++) {
       if (i === inventory.length - 1) {
        console.log( "The last car is car number" + " " + inventory.length + "." + " " + "It is a" + " " + inventory[i].car_year + " " + inventory[i].car_make+ " " + inventory[i].car_model+ ".");
           }
         }
      }
