...
//  Advanced array method answer
let carFound = inventory.filter(car => car.id === 33);
console.log(`Car 33 is a ${carFound[0].car_year} ${carFound[0].car_make} ${carFound[0].car_model}` )
...
//  Advanced array method answer
lastCar = inventory.filter(value => inventory.indexOf(value) === (inventory.length-1));  
console.log(`Make and model of last car in last car in invetory are: ${lastCar[0].car_make} and ${lastCar[0].car_model}`);
...
//     }
// }
// console.log('cars older than 2000 are: '+ oldCars.length); 

//Advanced array answer
oldCars = inventory.filter(item => item.car_year < 2000);
console.log('cars older than 2000 are: '+ oldCars.length); 
