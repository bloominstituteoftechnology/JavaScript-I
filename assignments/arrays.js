...
//   let car_year = inventory[i].car_year;
//   let car_make = inventory[i].car_make;
//   let car_model = inventory[i].car_model;
//   if (inventory[i].id === 33) {
//     console.log(`Car 33 is a ${car_year} ${car_make} ${car_model}`);
//   }
// }

let car33 = inventory.filter(function(value) {
  if(value.id === 33) {
    let year = value.car_year;
    let make = value.car_make;
    let model = value.car_model;
...
//   return arr;
// }
//   console.log(sortArray(carModels));
let cars = inventory.map( function(car) {
...
let allCarYears = inventory.filter( function(car) {
...
let oldies = inventory.map( function(car) {
...
let luxuryCars = inventory.filter( function(car) {
