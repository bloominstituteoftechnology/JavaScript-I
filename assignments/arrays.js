...
// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  ntory?  Log the make and model into the console.What is the make and model of the last car in the inve
let lastCar = 0;
for (i = 0; i < inventory.length; i++) {
    if(i == inventory.length-1){
        lastCar = console.log(inventory[i].car_make + ' ' + inventory[i].car_model);
    }
}
...
for (i = 0; i < inventory.length; i++) {
    ...
    carYears = carYears.sort(function (a, b) {
        return a - b;
    });
}
