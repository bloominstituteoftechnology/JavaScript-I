...
console.log(`Car ${inventory[32].car_make} is a ${inventory[32].car_year} ${inventory[32].car_model}` );
...
let carYearDex = carYears.length -1;

for (let i = 0; i <= carYearDex; i++){

    let baseCase = 2000;

    if (carYears[i] < baseCase){
