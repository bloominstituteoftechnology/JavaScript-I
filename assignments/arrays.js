...
let lastModel = inventory[lastCar].car_model;
let lastMake = inventory[lastCar].car_make;
console.log(`${lastModel} & ${lastMake}`);
...
for (let i = 0; i < inventory.length; i++) {
    ...
    BMW&&Audi.push(inventory[i].car_make)
}
console.log(JSON.stringify(BMW&&Audi));
