...
let carModels = [];
    ...
    //@@@ Getting ONLY the car models from the inventory array into the new carModels array
for (let i = 0; i < inventory.length; i++) {
    carModels.push(inventory[i].car_model)
}

    //@@@ sorting alphabeticaaly with .sort() and printing out the result
...
const BMWAndAudi_JSON = JSON.stringify(BMWAndAudi)

console.log(BMWAndAudi_JSON);
