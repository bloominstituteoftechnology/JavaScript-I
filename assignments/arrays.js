...
console.log("The last car is " + inventory[49].car_make + " " + inventory[49].car_model);
...
console.log("Car years are " + carYears);
...
console.log("Cars that older than the year 2000 are " + oldCars.length + " cars."); 
