...
{"id":2,"car_make":"Mafinzda","car_model":"Miata MX-5","car_year":2001},
...
//my solution
// let lastCar = 0;
// lastCar = 'inventory["car_make"] + inventory["car_model"]'

for (let lastCar = 49; lastCar < inventory.length; lastCar++ ){
...
// for(let carYears = 0; carYears < inventory.sort; i++){
//   carYears.sort(); //?
//   console.log(carYears);
//   // console.log(`${inventory[carYears].car_year}`); //?
