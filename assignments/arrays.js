...
// id of 33 by logging the car's year, make, and model in the console log provided to you below:

let car = inventory[32];
console.log("Year: ", car.car_year, ", Make : ", car.car_make, ", Model : ", car.car_model);
