...
const findCar = function(array, id) {
...
let foundCar = findCar(inventory, 33);
console.log(`Car 33 is a ${foundCar["car_year"]} ${foundCar["car_make"]} ${foundCar["car_model"]}`);


// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = findCar(inventory, inventory.length);
