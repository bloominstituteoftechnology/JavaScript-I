...
function compareLowerCase(a, b) {
  ...
  return aLower < bLower ? -1 : aLower > bLower;
}

carModels.sort(compareLowerCase);

console.log("ALL UNIQUE CAR MODELS (ALPHABETICAL):");
...
console.log("CAR YEARS (SORTED BY ID):");
...
console.log("NUMBER OF CARS OLDER THAN 2000: " + oldCarCount); 
...
console.log("Cars matching make \"BMW\" and make \"Audi\"");
