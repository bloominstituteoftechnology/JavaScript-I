...
// 1. Loop thru inventory array, push car_model property into carModels array
// 2. Sort carModels array alphabetically
// 3. Console.log carModels
...
// 1. Loop thru inventory array, push car_year property into carYears array
// 2. Sort carYears array by Year
// 3. Console.log carYears
...
// 1. Loop thru carYears array, push year into oldCars array if older than 2000
// 2. console.log oldCars.length

let oldCars = [];
for (let i = 0; i < carYears.length; i++) {
  if (carYears[i] < 2000) {
    oldCars.push(carYears[i]);
  } else if (carYears[i] >= 2000) {
  }
}
...
// 1. Loop through inventory array, push car into BMWAndAudi array if car_make is one of those
// 2. use JSON.stringify to show results in console
