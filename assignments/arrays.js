...
console.log(`Last car on the inventory, Make: ${lastCar.car_make} ,  Model:  ${lastCar.car_model}`);
...
for (let i =0; i < inventory.length; i++ ) {
  ...
  if ( inventory[i].car_make.includes("BMW") || inventory[i].car_make.includes("Audi")) {
