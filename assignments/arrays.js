...
// console.log(`this is a template string ${inventory[32].car_model} more strings`);
// console.log('this is not a template string ' + inventory[32].car_model + ' more strings');
