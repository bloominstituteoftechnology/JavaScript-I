...
// console.log(`Car 33 is a ${inventory.car-year} ${inventory.car-make} ${inventory.car-model}`);


// let carSearch = inventory[33 -1];
...
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  I could not figure out how to sort this A-Z  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
