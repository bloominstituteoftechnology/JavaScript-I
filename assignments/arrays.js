...
function carFinder(inventory, value) {
...
// let carModels = [inventory.sort(function (a, b) { return a.car_model == b.car_model ? 0 : (a.car_model < b.car_model ? -1 : 1); })];
function dynamicSort(car_model) {
  let sortOrder = 1;
  if (car_model[0] === "-") {
    sortOrder = -1;
...
console.log(inventory.sort(dynamicSort("car_model")));
