...
for (let i = 0; i < inventory.length; i++) {
    if (inventory[i].id === 33) {
        console.log(`Car 33 is ${inventory[i].car_year} ${inventory[i].car_make} ${inventory[i].car_model}`);
    }
}
// ==== Challenge 2 ====
...
// ==== Challenge 6 ====
// A buyer is interested in seeing only BMW and Audi cars within the inventory.  Return an array ithat only contains BMW and Audi cars.  Once you have populated the BMWAndAudi array, use JSON.stringify() to show the results of the array in the console.
let BMWAndAudi =[];
for (let i = 0; i < inventory.length; i++) {
