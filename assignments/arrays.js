...
console.log("Last car make and model:", lastCar.car_make, lastCar.car_model);
...
console.log("Alphabetical list:", carModels.sort());
...
console.log("Cars made before 2,000 A.D.:", oldCars);
...
console.log("All BMW and Audi cars:", results);
