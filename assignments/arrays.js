...
let selector = inventory[33];
let year = selector.car_year;
let make = selector.car_make;
let model = selector.car_model;
...
console.log (`The models of the cars in the lot are as follows: ${carModels}`)
...
console.log(`The years of the cars in the lot are as follows: ${carYears}`);
...
console.log(`Regarding BMWs and Audis, this is the information we have about our cars: ${JSON.stringify(BMWAndAudi)}`);
