...
console.log('Make and model of last car in inventory: '+inventory[lastCar].car_make+' '+inventory[lastCar].car_model+'.');
...
console.log('Amount of old cars: '+oldCars.length);
...
for(let i=0; i<inventory.length; i++)
{
    ...
    let carMake = currentCar.car_make;
