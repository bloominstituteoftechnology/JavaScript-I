...
// const carYear = inventory[33-1].car_year;
// const carMake = inventory[33-1].car_make;
// const carModel = inventory[33-1].car_model;
// const carId = inventory[33-1]['id'];
// console.log(`Car ${carId} is a ${carYear} ${carMake} ${carModel}`);

// Not sure if this is what I was supposed to do but there you have it. 
const carFinder = function(inventory, carId) {
    for (let i = 0; i < inventory.length; i++) {
        if (inventory[i].id === carId - 1) {
...
// carYears array you just created, find out how many cars were made before the year 2000 by populating 
...
// that only contains BMW and Audi cars.  Once you have populated the BMWAndAudi array, use JSON.stringify() to show the results of the array in the console.
let BMWAndAudi =[];
for (let i = 0; i < inventory.length; i++) {
