...
// console.log('Car arr[i] <=1,2,3,4["car_make", "car_model", ];')
...
//     carModel: car_model,
//     id: 33,
//     carReturner: function(){
//     return 'car 33 is a ' + this.carYear + this.carMake + this.carModel;
//     }
// }

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
// (`${inventory[0] ["car_make"]} ${inventory[0] ["car_model"]}`)
let lastCar = 0;
...
for (let i = 0; i < inventory.length; i++){
let inventoryModels = inventory[i].car_model;
carModels.push(inventoryModels);
carModels.sort();
