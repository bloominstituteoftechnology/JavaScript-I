...
if (inventory[i]["id"] == myID){
// carYear = inventory[i]["car_year"]
// carMake = inventory[i]["car_make"]
// carModel = inventory[i]["car_model"]
  console.log(`Car ${myID} is a ${inventory[i]["car_year"]} ${inventory[i]["car_make"]} ${inventory[i]["car_model"]}` );
  }
  }
...
//let lastCar = 0;
console.log(`Car ${inventory.length} is a ${inventory[inventory.length-1]["car_year"]} ${inventory[inventory.length-1]["car_make"]} ${inventory[inventory.length-1]["car_model"]}` )
...
console.log(`we have ${oldCars} old cars on the lot`)
