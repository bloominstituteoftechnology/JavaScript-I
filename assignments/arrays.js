...
for(let i = 0; i < len; i++){
  if(inventory[i]["id"] === 33){
    console.log('Vehicle with ID of 33', inventory[i]["car_year"], inventory[i]["car_make"], inventory[i]["car_model"]);
  }
}
...
console.log('Last Vehicle in Array', lastCar["car_make"], lastCar["car_model"]);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console

// let carModels = inventory[20].car_model.replace(' ', '');
let carModels = [];
let sortedByCarModelArr = inventory.sort((a,b) => a["car_model"].toLocaleLowerCase('en-US').localeCompare(b["car_model"].toLocaleLowerCase('en-US')));
for(let i = 0; i < len; i++){
...
console.log('All Vehicle Years', carYears);
...
console.log('Vehicles older than year 2000: ', oldCars);
