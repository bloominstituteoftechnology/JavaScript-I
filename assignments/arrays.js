...
console.log(`\nChallenge 2: ${inventory[lastCar].car_make} ${inventory[lastCar].car_model}`);
...
console.log(`\nChallenge 6: ${JSON.stringify(BMWAndAudi)}`);
