...
console.log(
inventory.sort(function(carModels, carModelsSorted){
  if(carModels.car_model < carModelsSorted.car_model){
    return -1;
  }
  if(carModels.car_model > carModelsSorted.car_model){
    return 1;
...
//Here I didn't use the carYears array. 
for(i = 0; i < inventory.length; i++){
...
if((inventory.car_make === 'Audi') || (inventory.car_make === 'BMW')){
