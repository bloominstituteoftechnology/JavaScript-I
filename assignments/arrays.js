...
for (i = 0; i < inventory.length; i++) {
  if (inventory[i].id === 50) {
    ...
    make50 = inventory[i].car_make;
    model50 = inventory[i].car_model;
  }
}
console.log(`Last car in inventory is a ${make50} ${model50}.`);

// make50 = inventory[inventory.length - 1].car_make;
// inventory.length = 50;
