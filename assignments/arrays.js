...
for (let i = 0 ; i < inventory.length ; i++) {
    let individualInv = inventory[i];
    // console.log(individualInv);
    // console.log(individualInv.car_model);
    carModels.push(individualInv.car_model)
...
let invYear = inventory[i]; // individual array item (object)
// console.log(invYear);
carYears.push(invYear.car_year);
