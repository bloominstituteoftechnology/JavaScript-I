...
inventory.forEach(function(element) {
    if (element.id === 33) {
        console.log(element.car_model + '' + element.car_make + '' + element.car_year)
    }
})
...
console.log(lastCar)
console.log('The make is ' + lastCar.car_make + ' and model is ' + lastCar.car_model)
