...
// console.log(car 33 is a "car_make" "car_model" "car_year");

//  ( car 33 `Car 33 is a *car year goes here* *car make goes here* *car model goes here*` );
...
let BMWAndAudi = [];
for(let index=0; index <inventory.length; i++) {
    if(inventory.length[index].car_make === "BMW") || (inventory[index].car_make === "Audi"){
