...
// let oldCars = [];                                   //new array Old Cars
// for (let i = 0; i < inventory.length; i++) {        //forloop 
//     if (carYears[i] < 2000) {                       //if else, if item in car years (previous array) is greater than 2000
//     oldCars.push(carYears[i]);                      //push each item in car years that is greater than 2000 to old cars array
//     } else { 
