...
console.log(`The make of the last car is ${inventory[lastCar].car_make}, and the model is ${inventory[lastCar].car_model}`);
...
// using filter
oldCars = inventory.filter( function( item ) {
...
// using filter:
BMWAndAudi = inventory.filter( function( item ) {
