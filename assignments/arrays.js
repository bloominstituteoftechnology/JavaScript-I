...
console.log(inventory[32]) // Use this to find car 33
...
// console.log(`The last car in the inventory is a ${inventory[lastCar].car_year} ${inventory[lastCar].car_make} ${inventory[lastCar].car_model}`)
