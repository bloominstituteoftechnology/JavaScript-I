...
let lastCar = 0;
console.log(`Our last car is a ${inventory[lastCar].car_year} ${inventory[lastCar].car_make} ${inventory[lastCar].car_model}.`);
//OR
let lastCar = 0
...
for (i=0; i<inventory.length; i++) {
  ...
  BMWAndAudi.push(`We have a ${inventory[i].car_year} ${inventory[i].car_make} ${inventory[i].car_model}`)}
}
