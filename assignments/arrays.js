...
console.log(`Last Car Make: ${inventory[lastCar].car_make}, Last Car Model: ${inventory[lastCar].car_model}`)

//If you want to use a for loop
for (let i = 0; i < lastCar; i++) {
    if(inventory[i].id === lastCar) {
        console.log(`Last Car Make: ${inventory[i].car_make}, Last Car Model: ${inventory[i].car_model}`)
    }
}
