...
let carMake = inventory
  .filter(car => car.id === 33)
console.log(`Car 33 is a ${carMake[0].car_year} ${carMake[0].car_make} ${carMake[0].car_model}`)

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = []
lastCar = inventory
  .filter(last => last.id === 50)
console.log(`The last car is a ${lastCar[0].car_make} ${lastCar[0].car_model}`)
...
let carYears = []
carYears = inventory
  .filter(years => years.car_year < 2000)
...
let oldCars = []
oldCars = carYears
  .filter(old => oldCars.push(carYears.car_year < 2000))
console.log(oldCars)
