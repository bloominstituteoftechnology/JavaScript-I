...
console.log(`The car with an id of 33 is ${inventory[32].car_make} ${inventory[32].car_model} ${inventory[32].car_year} `);



// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = inventory[49].car_make;
let model = inventory[49].car_model; // grab the last car
 //popping car year
console.log("The last car's make and model is" , lastCar , model);
...
carModels.sort();
console.log(`${carCount} cars added. The cars in Alphabetical order are as follows: ${carModels} `);

// ==== Challenge 4 ====
// The accounting team needs all the years from every car on the lot. Create a new array from the dealer data containing only the car years and log the result in the console.
let carYears = [];
let yearCount = 0; //counter
for(let i = 0; i <inventory.length; i++){
    carYears.push(inventory[i].car_year);
    yearCount++;
}

console.log(`Here are all the years of the vehicles on the lot: ${carYears}`);
...
console.log(`Here are all the old cars: ${oldCars}`); 
...
console.log(`Here are our BMWs and Audis:`+  JSON.stringify(BMWAndAudi));
