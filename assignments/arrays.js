...
// console.log(lastCar)
console.log(`The last car in the inventory is the ${inventory[lastCar].car_make} ${inventory[lastCar].car_model}`);
...
for (i = 0; i < inventory.length; i++) {
    ...
    if (inventory[i].car_make === "Audi" || inventory[i].car_make === "BMW") {
        BMWAndAudi[temp_BA] = inventory[i];
        temp_BA++;
    }
}
BMWAndAudi = JSON.stringify(BMWAndAudi)

console.log("Showing the BMWAndAudi " + BMWAndAudi);