...
// let carModelsSorted = [];
// let carModelsSorted = inventory.sort(function(a, b){return a.car_model - b.car_model});
...
// carModelsSorted = inventory.sort(function(a, b) {
...
for (let i = 0; i < inventory.length; i++){
  ...
  const alpha = inventory[i].car_model;
  carModels.push(alpha);
