...
console.log(`Car33 is a ${inventory[32].car_year} ${inventory[32].car_make} ${inventory[32].car_model}`);
...
let lastCar = 0;
console.log();
console.log("The last car in the inventory is a "+inventory[inventory.length - 1].car_make+" "+inventory[inventory.length - 1].car_year);
...
console.log("There are "+countOldCars+" cars made before 2000: "+oldCars); 
