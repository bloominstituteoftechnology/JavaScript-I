...
let lastCar = 0;
console.log(lastCar(Lincoln, Town Car));

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
let carModels = [Town Car, Sebring, Magnum, Jetta, Ciera, TT, Q7, R-class, Yukon, Mustang, Evora,Econoline E250, Camry, LSS, XC70, 300M, Escort, Wrangler, Ram Van 3500, GTO,
    6 Series, Topaz, Aerio, Q, Escalade, 525, MR2, Talon, Express 1500, Wrangler, Familia, Bravada, Prizm, Skylark, Montero Sport, Intrepid, Ram Van 1500, Cavalier, Esprit
    G35, E-Class, Windstar, 4000CS Quattro, Fortwo, Accord, Galant, Defender Ice Edition, Miata MX-5,Navigator];
