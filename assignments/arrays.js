...
for (let i = 0; i < inventory.length; i++){
	// did upper case to get a true in order as "riolet" goes at the end because of casing
...
for (let i = 0; i < inventory.length; i++){
	...
	console.log("Cars from the year 2000 or older:", oldCars.length); 
	// console.log(oldCars); 
