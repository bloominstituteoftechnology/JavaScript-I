...
// a used car dealer that has 50 cars in their inventory. The car dealer has
// all of their inventory housed in the array seen below. Scroll down past
...
for (let i = 0; i < inventory.length; i++) {
  if (i === 32) {
    console.log(
      `Car 33 is a ${inventory[32].car_year} ${inventory[32].car_model} ${inventory[32].car_make}.`
    );
  }
};
...
for (let i = 0; i < inventory.length; i++) {
  if (i === (inventory.length - 1)) {
    console.log(
      `The last car is a ${inventory[i].car_year} ${inventory[i].car_model} ${inventory[i].car_make}.`
    );
...
// the carYears array you just created, find out how many cars were made before the year 2000
