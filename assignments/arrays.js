...
for(let i=0; i < inventory.length; i++) {
  ...
  if (inventory[i].id === 33) {
    const mycarList = inventory[32]
    console.log(`${mycarList.car_year} ${mycarList.car_make} ${mycarList.car_model}`)
  }
}
...
for(let i=0; inventory[i].car_year <= 1999;) {
