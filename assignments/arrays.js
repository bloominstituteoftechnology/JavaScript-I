...
console.log('Car 33 is a ' + inventory[33].car_year.toString()
            + ' ' + inventory[33].car_make.toString()
            + ' ' + inventory[33].car_model.toString());



// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = inventory[len-1];
console.log('Last car is a ' + lastCar.car_make.toString() + ' ' + lastCar.car_model.toString());
