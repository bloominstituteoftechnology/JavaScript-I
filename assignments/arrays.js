...
lastCar = inventory[inventory.length - 1];
 console.log(`The last car in the inventory is make: ${lastCar.car_make} model: ${lastCar.car_model}`);
...
// carModels.sort();
// inventory.sort(function(a, b){carModels.push(a.car_model - b.car_model) });
...
console.log('list of years. ', carYears);
