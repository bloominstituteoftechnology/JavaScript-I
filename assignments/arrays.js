...
let lastCar = 0;
console.log(`The last car make is ${inventory[inventory.length - 1].car_make} and the model is ${inventory[inventory.length - 1].car_model}.`);
...
let sorted = carModels.sort( (a,b) => a < b ? -1 : a > b ? 1 : 0);
