...
console.log(`Car 33 is a ` + inventory[33].car_make +  ` ` + inventory[33].car_model + ` ` + inventory[33].car_year );
...
console.log(inventory.sort((a, b) => {
    carModels = a.car_model.localeCompare(b.car_model);
    return carModels;
}));
...
if(inventory.car_make == "BMW" || "Audi"){
    BMWAndAudi = inventory.map(a => a.car_make);
}
