...
function carInfo(array, key, value) {
  for (let i = 0; i < array.length; i++) {
    if (array[i][key] === value) {
      return `Car ${array[i].id} is a ${array[i].car_year} ${array[i].car_make} ${array[i].car_model}.`;
    }
  }
}
console.log(carInfo(inventory, 'id', 33));
...
const GetCarYears = function(key, value) {
  for (let i = 0; i < inventory.length; i++) {
