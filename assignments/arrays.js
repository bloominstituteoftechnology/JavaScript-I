...
let lastCar = 0;
console.log("the make of the last car is " + inventory[inventory.length - 1].car_make + " while the model is " + inventory[inventory.length - 1].car_model);
