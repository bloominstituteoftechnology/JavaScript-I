...
function findCar(carID){
    let carArrayID = carID -1;
    return `Car ${inventory[carArrayID].id} is a ${inventory[carArrayID].car_year} ${inventory[carArrayID].car_make} ${inventory[carArrayID].car_model}`;
}
...
function findLastCar(){
    let carArrayID = inventory.length - 1;
    return `Car ${inventory[carArrayID].id} is a ${inventory[carArrayID].car_year} ${inventory[carArrayID].car_make} ${inventory[carArrayID].car_model}`;
}
...
let carModels = [];
function findAllCarModels(){
    for (i = 0; i < inventory.length; i++){
        carModels.push(inventory[i].car_model);
        //console.log(inventory[i].car_model.toString());
    }
...
let BMWAndAudi =[];
function findAllSpecificCars(carMakeOne, carMakeTwo){
    for (i = 0; i < inventory.length; i++){
        if (((inventory[i].car_make) == carMakeOne) || ((inventory[i].car_make) == carMakeTwo)){
