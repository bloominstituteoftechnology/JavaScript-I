...
let lastCar = 'The last car is a' + ' ' + inventory[inventory.length-1].car_year + ' ' + inventory[inventory.length-1].car_make + ' ' + inventory[inventory.length-1].car_model;
console.log(lastCar);
