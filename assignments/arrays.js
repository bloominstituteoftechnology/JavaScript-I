...
for (i=0; i<inventory.length; i++) {
  if (inventory[i].id === 33)
    cMake = inventory[i].car_make;
    cModel = inventory[i].car_model;
    cYear = inventory[i].car_year;
}

console.log(`Car 33 is a ${cYear} ${cMake} ${cModel}` );
...
let cYear = "";
for (i=0; i<inventory.length; i++) {
  if (inventory[i].id === inventory[inventory.length-1].id)
    cMake = inventory[i].car_make;
    cModel = inventory[i].car_model;
    cYear = inventory[i].car_year;
}

console.log(`Last car is a ${cMake} ${cModel}` );
...
for (i=0; i<inventory.length; i++) {
  if (inventory[i].car_make === "BWM" || inventory[i].car_make === "Audi") {
