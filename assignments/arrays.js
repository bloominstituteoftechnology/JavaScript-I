...
//  let carThreeThree = inventory[32];
function storeThirtyThree(array, callback){
    callback(array[32]);
}
storeThirtyThree(inventory, (item)=>{
    carThreeThree = item;
});
