...
let carModels = [];
for (let i = 0; i < inventory.length; i++) {
    carModels.push(inventory[i].car_model); //create array of all car models
}
//this one made me really want to throw things.
function carModelSort(arr) {
    let temp;
    let swapped;
    do {
        swapped = false;
