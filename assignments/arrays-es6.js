...
// function ch1(inventory) {
//   function report(id, year, make, model) {
//     return `Car ${id} is a ${year} ${make} ${model}`
//   }

//   for (car of inventory) {
//     const { id, car_make: make, car_model: model, car_year: year } = car
//     if (id === 33) { return (report(id, year, make, model)) }
//   }
// }

const report = (id, year, make, model) => `Car ${id} is a ${year} ${make} ${model}`
const ch1 = inventory => {
  const { id, car_make: make, car_model: model, car_year: year } = inventory.find(({id}) => id === 33)
  return report(id, year, make, model)
}

// console.log(ch1(inventory))

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.

// function ch2(inventory) {
//   const [{ car_make: make, car_model: model }] = inventory.slice(-1)
//   return { make, model }
// }
...
// console.log(ch2(inventory))

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console

// function ch3(inventory) {
//   function insertAtIndex(ix, arr, val) {
//     return ix === -1 
//            ? [...arr, val]
//            : [...arr.slice(0, ix), val, ...arr.slice(ix)] 
//   }

//   let sorted = []
  
//   for (car of inventory) {
//     sorted = insertAtIndex(sorted.findIndex(function(car_) {
//       return (car_.car_model.toLowerCase() > car.car_model.toLowerCase())
//     }), sorted, car)
//   }
...
// I could use .sort(), but just experimenting with implementing my own insertion sort
// which _should_ be decently efficient for small arrays (< 1e6 elements)
const insertAtIndex = (ix, arr, val) => 
...
const ch4 = inventory => inventory.map(({ car_year }) => car_year)

// console.log(ch4(inventory))

// ==== Challenge 5 ====
// The car lot manager needs to find out how many cars are older than the year 2000. Using the carYears array you just created, find out how many cars were made before the year 2000 by populating the array oldCars and logging it's length.

// function ch5(inventory) {
//   let oldCars = []
...
const ch5 = inventory =>
  inventory.filter(({ car_year }) => car_year < 2000).length

// console.log(ch5(inventory))

// ==== Challenge 6 ====
// A buyer is interested in seeing only BMW and Audi cars within the inventory.  Return an array that only contains BMW and Audi cars.  Once you have populated the BMWAndAudi array, use JSON.stringify() to show the results of the array in the console.

// function ch6(inventory) {
//   let BMWAndAudi = []

//   for (car of inventory) {
//     /(BMW|Audi)/.test(car.car_make) && BMWAndAudi.push(car)
//   }
