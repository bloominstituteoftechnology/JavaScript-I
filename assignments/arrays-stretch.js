...
let inventory = [
    ...
    let carModels = inventory.map((car, index, cars) => {return car.car_make;})
    ...
    // }
    let carYears = inventory.map((car, index, cars) => {return car.car_year;})
    ...
    let BMWAndAudi = inventory.filter((car) => {return car.car_make === 'BMW' || car.car_make === 'Audi'});
