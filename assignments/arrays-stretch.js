...
const findThirtyThree = function(currentObject){
  // console.log (currentObject["id"] === 33);
  return currentObject["id"] === 33;
};

const filteredArray = inventory.filter(findThirtyThree);

// filteredArray.forEach(function (currentObject){
//   console.log("Car 33 is a " + currentObject["car_year"]+" "+currentObject["car_make"]+" "+currentObject["car_model"]);
// });
...
let oldCars =[];
oldCars = inventory.filter(function(carYearElement){
  return carYearElement["car_year"]<2000;
});
...
let BMWAndAudi =[];
BMWAndAudi = inventory.filter(function(carObject){
  return (carObject["car_make"] === "BMW") || (carObject["car_make"] === "Audi");
});
...
//   };
// });
BMWAndAudi.forEach(function(carObject){
