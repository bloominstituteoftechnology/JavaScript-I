...
let arr = inventory.filter( item => item.id === 32);
console.log(arr);

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let arr1 = inventory.filter( i => inventory[i + 1] === undefined);
console.log(arr1);//?
// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console


console.log(inventory.map( model => model.car_model).sort( (a, b) => (a < b ? -1 : a > b ? 1 : 0)));


// ==== Challenge 4 ====
// The accounting team needs all the years from every car on the lot. Create a new array from the dealer data containing only the car years and log the result in the console.

console.log(inventory.map( item => item.car_year) );
// ==== Challenge 5 ====
// The car lot manager needs to find out how many cars are older than the year 2000. Using the carYears array you just created, find out how many cars were made before the year 2000 by populating the array oldCars and logging it's length.
console.log(inventory.filter ( item => item.car_year < 2000) );
...
let jstr = JSON.stringify(inventory.filter( car => car.car_make === "Audi" || car.car_make === "BMW"));
console.log(jstr);
